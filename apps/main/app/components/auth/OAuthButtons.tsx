...
export default function OAuthButtons({ disabled = false }: OAuthButtonsProps) {
    ...
    const handleGoogleAuth = useCallback(() => {
        ...
        // For now, we'll show a toast since OAuth is not configured
        if (process.env.NODE_ENV === 'development') {
            toast.info(
                'Google OAuth will be configured once client credentials are available'
            );
        } else {
    ...
    const handleGitHubAuth = useCallback(() => {
        ...
        if (process.env.NODE_ENV === 'development') {
            toast.info(
                'GitHub OAuth will be configured once client credentials are available'
            );
        } else {
