...
describe('Onboarding Wizard', () => {
    ...
    it('renders welcome step by default', () => {
        ...
        expect(screen.getByText('Let\'s get you set up with your first workspace')).toBeInTheDocument();
    ...
    it('displays feature overview cards', () => {
        ...
        expect(screen.getByText('Flexible Data Management')).toBeInTheDocument();
    ...
    it('proceeds to templates step after workspace creation', async () => {
        ...
        const nameInput = screen.getByPlaceholderText('e.g., Acme Inc, Marketing Team, Personal Projects');
    ...
    it('allows skipping the onboarding', () => {
        ...
        expect(localStorageMock.removeItem).toHaveBeenCalledWith('struktura-onboarding-state');
    });
