...
import { workspaceApi, type WorkspaceDashboardData, type CollectionSummary, type RecentActivity } from '../../lib/api/index.js';
...
export async function loader({ params }: LoaderFunctionArgs) {
    ...
    try {
        const dashboardData = await workspaceApi.getWorkspaceDashboard(workspaceId);
...
export default function WorkspaceDashboard() {
    ...
    const [collectionViewMode, setCollectionViewMode] = useState<CollectionViewMode>('grid');
            ...
            <div className="min-h-screen bg-background">
                <div className="container mx-auto px-4 py-8">
                    <div className="max-w-md mx-auto text-center">
                        ...
                        <h1 className="text-xl font-semibold mb-2">Unable to load workspace</h1>
    ...
    const filteredCollections = collections.filter((collection: CollectionSummary) =>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">
                                {stats.totalCollections === 1 ? 'collection' : 'collections'} in workspace
                            </p>
                        </CardContent>
                    </Card>
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">
                                {stats.totalRecords === 1 ? 'record' : 'records'} across all collections
                            </p>
                        </CardContent>
                    </Card>
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">
                                {stats.activeMembers === 1 ? 'active member' : 'active members'}
                            </p>
                        </CardContent>
                    </Card>
                </div>
                    ...
                    <TabsContent value="collections" className="mt-6">
                        ...
                        {filteredCollections.length === 0 ? (
                            ...
                            <div className={
                                ...
                                {filteredCollections.map((collection: CollectionSummary) => (
                                    <Card 
                                        key={collection.id} 
                                        className={`cursor-pointer hover:shadow-md transition-shadow ${
                                            collectionViewMode === 'list' ? 'flex items-center' : ''
                                        }`}
                                        onClick={() => navigate(`/workspaces/${params.workspaceId}/collections/${collection.id}`)}
                                    >
                                        {collectionViewMode === 'grid' ? (
                                            <>
                                                <CardHeader className="pb-3">
                                                    <div className="flex items-start justify-between">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            >
                                                                {collection.icon || getCollectionInitials(collection.name)}
                                                            </div>
                                                            <div>
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center gap-4 text-sm text-muted-foreground">
                                                            <div className="flex items-center gap-1">
                                                                ...
                                                                {collection.recordCount.toLocaleString()} records
                                                            </div>
                                                            <div className="flex items-center gap-1">
                    ...
                    <TabsContent value="activity" className="mt-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Stay up to date with what's happening in your workspace
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                    ...
                                    <div className="space-y-4">
                                        {recentActivity.map((activity: RecentActivity) => (
                                            <div key={activity.id} className="flex items-start gap-3 pb-4 border-b last:border-b-0">
                                                ...
                                                {activity.metadata?.collectionId && (
                                                    <Button variant="ghost" size="sm" asChild>
                                                        <Link to={`/workspaces/${params.workspaceId}/collections/${activity.metadata.collectionId}`}>
